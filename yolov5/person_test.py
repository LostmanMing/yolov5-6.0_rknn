...
ONNX_MODEL = '/home/b610/zgm/rknn/rknn-toolkit2/samples/person_v5_best.onnx'
RKNN_MODEL = '/home/b610/zgm/rknn/rknn-toolkit2/examples/onnx/yolov5/person_v5_best.rknn'

IMG_PATH = '/home/b610/zgm/rknn/rknn-toolkit2/examples/onnx/yolov5/person.jpg'
...
if __name__ == '__main__':
    ...
    # pre-process config
    print('--> Config model')
    rknn.config(mean_values=[[0, 0, 0]], std_values=[[255, 255, 255]],float_dtype='float16')
    print('done')
